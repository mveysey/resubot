            ...
            <section className="section">
                <div className="columns">
                    ...
                    <div className="column">
                        <h1 className="title is-size-2">John Doe</h1>
                        <h2 className="subtitle is-size-4">Web Developer</h2>
                        <p className="has-text-info">Email: johndoe@example.com</p>
                        <p className="has-text-link">LinkedIn: linkedin.com/in/johndoe</p>
                        <p className="has-text-link">GitHub: github.com/johndoe</p>
                    </div>
                </div>
                <hr />
                <p>
