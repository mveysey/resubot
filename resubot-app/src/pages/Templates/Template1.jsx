        ...
        <div className="container">
            ...
            <section className="section">
                ...
                <div className="content">
                    ...
                    <div className="box">
                        <h3>Front-end Developer - Web Solutions Ltd.</h3>
                        <p className="subtitle is-6">July 2017 - Dec 2019</p>
                        <ul>
                    ...
                    <div className="box">
                        <h3>Junior Web Developer - CodeCrafters</h3>
                        <p className="subtitle is-6">May 2015 - June 2017</p>
                        <ul>
                    ...
                    <div className="column is-6">
                        <div className="card">
                            <div className="card-content">
                                ...
                                <p className="subtitle is-6">Role: Front-end Developer</p>
                    ...
                    <div className="column is-6">
                        <div className="card">
                            <div className="card-content">
                                ...
                                <p className="subtitle is-6">Role: Full-stack Developer</p>
            ...
            <section className="section">
                <h2 className="title">Certifications & Awards</h2>
                <ul>
